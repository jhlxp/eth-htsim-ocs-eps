...
def parse_args():
    parser = argparse.ArgumentParser(description="Run dragonfly simulations with 2% failed links.")
...
if __name__ == '__main__':
    ...
    output_dir = os.path.join(args.output_root, "df", topo, "fail_2p")
